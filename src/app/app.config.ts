...
export const b2cPolicies = {
  // ab multiple policies ka concept nahi, sirf ek authority
  authorities: {
    signUpSignIn: {
      // yahi tumhare Endpoints screen ka "Authority URL" hai
      authority: `https://${b2c.tenantName}.ciamlogin.com/${b2c.tenantId}`,
    },
  },
  // domain jisko MSAL trusted maanta hai
  authorityDomain: `${b2c.tenantName}.ciamlogin.com`,
};
